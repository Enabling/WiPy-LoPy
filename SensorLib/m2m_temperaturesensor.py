...
class TemperatureSensor(M2M_Sensor):
    def __init__( self ):

        M2M_Sensor.__init__(self, 5, self.__class__.__name__)
        self.data['doubleMeterValue'] = 0
        self.stream_def["properties"]["value"]["type"] = "number"
        #self.stream_def = {"type":"object","properties":{"value":{"type":"number"}},"additionalProperties":False,"title":self.__class__.__name__}
